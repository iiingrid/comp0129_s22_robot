...
main (int argc, char** argv)
{
  ...
  // Create a cw3 object and update the parameters
  CW3 cw3_obj (nh);
  ...
  ros::Publisher joint_pub = nh.advertise<sensor_msgs::JointState>("/move_group ake_controller_joint_states", 0);
